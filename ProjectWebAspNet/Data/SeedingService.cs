...
using ProjectWebAspNet.Models.Emums;

namespace ProjectWebAspNet.Data
{
    public class SeedingService
    {
        private ProjectWebAspNetContext _context;

        public SeedingService(ProjectWebAspNetContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 21), 3500.00, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 2, 21), 2200.00, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1991, 7, 21), 3000.00, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2001, 11, 21), 4000.00, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alexpink@gmail.com", new DateTime(1996, 6, 21), 3000.00, d2);
